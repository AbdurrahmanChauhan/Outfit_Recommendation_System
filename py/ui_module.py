...
class Ui_MainWindow(object):
    ...
    def ALL_PREDICT(self):
        ...
        file_path, _ = QFileDialog.getOpenFileName(None, "Select file", ".File/")

        # Check if a file path was selected
        if file_path:
            # Perform prediction only if a file path was selected
            ...
            # Notify the user if no file path was selected
